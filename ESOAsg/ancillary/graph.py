...
This is a direct copy of https://github.com/spacetelescope/spherical_geometry
It is copied here to avoid the need for the C routines required for the full
...
# LOCAL
from ESOAsg.ancillary import great_circle_arc as gca
from ESOAsg.ancillary import vector
from ESOAsg.ancillary import polygons as mpolygon
